...
public abstract class NewAbstractDayCountView extends View {
	...
	private List<Integer> datas = new ArrayList<>();//当前日期及其前11天的数据 size = 12
	...
	public NewAbstractDayCountView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		init(context);
	}

	public NewAbstractDayCountView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public NewAbstractDayCountView(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(Context context) {
		...
		mPaintRectBottom.setStyle(Paint.Style.FILL);
...
//			String monthStr = formatDayStr(day);//不足2位补0
//		
