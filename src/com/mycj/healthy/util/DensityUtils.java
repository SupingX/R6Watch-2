...
public class DensityUtils {
	...
	public static int dp2px(Resources rs, float dpVal) {
		return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpVal, rs.getDisplayMetrics());
	}
	...
	public static int sp2px(Resources rs, float spVal) {
		return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, spVal, rs.getDisplayMetrics());
	}
